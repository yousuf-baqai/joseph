        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('event_page_background_image','image','required',$record)?>
										 <?php echo form_item('event_page_main_heading','text','required',$record)?>
										 <?php echo form_item('event_page_sub_heading','text','required',$record)?>
