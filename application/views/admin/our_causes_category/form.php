        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('our_causes_category_name','text','required',$record)?>
										 <?php echo form_item('our_causes_category_slug','text','not-required',$record)?>
										 <?php echo form_item('our_causes_category_image','image','not-required',$record)?>
