        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <!-- <?php echo form_item('newletters_pdf','image','required',$record)?> -->
										 <?php echo form_item('newletters_heading','text','required',$record)?>
										 <?php echo form_item('newletters_year','text','required',$record)?>
										 <?php echo form_item('newletters_date','text','required',$record)?>
                     <input type='file' name='newletters_pdf' ><?php echo $news->newletters_pdf;?></input>
