        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">              
										 <?php echo form_item('contact_form_first_name','text','required',$record)?>
										 <?php echo form_item('contact_form_last_name','text','required',$record)?>
										 <?php echo form_item('contact_form_email','text','required',$record)?>
										 <?php echo form_item('contact_form_phone','text','required',$record)?>
										 <?php echo form_item('contact_form_message','textarea','required',$record)?>
