        ...
        <div class="box box-primary">
          ...
          <div class="col-md-8">
            <form role="form" action="<?php echo strtolower($action);?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">
                <?php echo form_item('header_navbar_text','text','required',$record);?>
                <?php echo form_item('header_navbar_link','text','required',$record);?>
                
                <?php if(!empty($record->header_navbar_parent_id) && $record->header_navbar_parent_id > 0):?>
                <?php echo form_item('header_navbar_column_1','textarea_editor','required',$record);?>
                <?php echo form_item('header_navbar_column_2','textarea_editor','required',$record);?>
                <?php endif;?>
              </div>
