...
class Event_page extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('event_page_background_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('event_page_background_image','event_page_main_heading','event_page_sub_heading',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'event_page_background_image' => $this->input->post('event_page_background_image',TRUE),
				'event_page_main_heading' => $this->input->post('event_page_main_heading',TRUE),
				'event_page_sub_heading' => $this->input->post('event_page_sub_heading',TRUE),
