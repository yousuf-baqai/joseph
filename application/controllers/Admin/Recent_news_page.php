...
class Recent_news_page extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('recent_news_page_background_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('recent_news_page_background_image','recent_news_page_main_heading',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'recent_news_page_background_image' => $this->input->post('recent_news_page_background_image',TRUE),
				'recent_news_page_main_heading' => $this->input->post('recent_news_page_main_heading',TRUE),
