...
class Staff_members extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('staff_members_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('staff_members_image','staff_members_name','staff_members_designation','staff_members_details','staff_members_twitter_link','staff_members_facebook_link','staff_members_google_link','staff_members_linkedin_link','staff_members_website_link','staff_members_read_more_button','staff_members_button_link',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'staff_members_image' => $this->input->post('staff_members_image',TRUE),
				'staff_members_name' => $this->input->post('staff_members_name',TRUE),
				'staff_members_designation' => $this->input->post('staff_members_designation',TRUE),
				'staff_members_details' => $this->input->post('staff_members_details',TRUE),
				'staff_members_twitter_link' => $this->input->post('staff_members_twitter_link',TRUE),
				'staff_members_facebook_link' => $this->input->post('staff_members_facebook_link',TRUE),
				'staff_members_google_link' => $this->input->post('staff_members_google_link',TRUE),
				'staff_members_linkedin_link' => $this->input->post('staff_members_linkedin_link',TRUE),
				'staff_members_website_link' => $this->input->post('staff_members_website_link',TRUE),
				'staff_members_read_more_button' => $this->input->post('staff_members_read_more_button',TRUE),
				'staff_members_button_link' => $this->input->post('staff_members_button_link',TRUE),
