...
class Staff_page extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('staff_page_background_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('staff_page_main_heading','staff_page_background_image',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'staff_page_main_heading' => $this->input->post('staff_page_main_heading',TRUE),
				'staff_page_background_image' => $this->input->post('staff_page_background_image',TRUE),
