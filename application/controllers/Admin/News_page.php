...
class News_page extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('news_page_background_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('news_page_background_image','news_page_heading','news_page_main_heading_span','news_page_main_heading','news_page_sub_heading','news_page_search_bar_text','news_page_section_heading',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'news_page_background_image' => $this->input->post('news_page_background_image',TRUE),
				'news_page_heading' => $this->input->post('news_page_heading',TRUE),
				'news_page_main_heading_span' => $this->input->post('news_page_main_heading_span',TRUE),
				'news_page_main_heading' => $this->input->post('news_page_main_heading',TRUE),
				'news_page_sub_heading' => $this->input->post('news_page_sub_heading',TRUE),
				'news_page_search_bar_text' => $this->input->post('news_page_search_bar_text',TRUE),
				'news_page_section_heading' => $this->input->post('news_page_section_heading',TRUE),
