...
class Our_causes_page extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('our_causes_page_background_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('our_causes_page_background_image','our_causes_page_main_heading',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'our_causes_page_background_image' => $this->input->post('our_causes_page_background_image',TRUE),
				'our_causes_page_main_heading' => $this->input->post('our_causes_page_main_heading',TRUE),
