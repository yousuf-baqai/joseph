...
class Our_causes extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('our_causes_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('our_causes_slug','our_causes_image','our_causes_heading','our_causes_description','our_causes_raised_amount','our_causes_goal_amount','our_causes_category',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
                'our_causes_slug' => $this->input->post('our_causes_slug',TRUE),
				'our_causes_image' => $this->input->post('our_causes_image',TRUE),
				'our_causes_heading' => $this->input->post('our_causes_heading',TRUE),
				'our_causes_description' => $this->input->post('our_causes_description',TRUE),
				'our_causes_raised_amount' => $this->input->post('our_causes_raised_amount',TRUE),
				'our_causes_goal_amount' => $this->input->post('our_causes_goal_amount',TRUE),
				'our_causes_category' => $this->input->post('our_causes_category',TRUE),
            ...
            $data['output_type']='result';
            $content["our_causes_category"]= $this->general->get($data);
