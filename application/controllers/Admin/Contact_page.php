...
class Contact_page extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('contact_page_background_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('contact_page_background_image','contact_page_heading','contact_page_sub_heading',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'contact_page_background_image' => $this->input->post('contact_page_background_image',TRUE),
				'contact_page_heading' => $this->input->post('contact_page_heading',TRUE),
				'contact_page_sub_heading' => $this->input->post('contact_page_sub_heading',TRUE),
