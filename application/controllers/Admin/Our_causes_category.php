...
class Our_causes_category extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('our_causes_category_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('our_causes_category_name','our_causes_category_slug','our_causes_category_image',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'our_causes_category_name' => $this->input->post('our_causes_category_name',TRUE),
				'our_causes_category_slug' => $this->input->post('our_causes_category_slug',TRUE),
				'our_causes_category_image' => $this->input->post('our_causes_category_image',TRUE),
