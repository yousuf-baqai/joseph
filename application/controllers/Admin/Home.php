...
class Home extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('home_page_section_one_background_image','home_page_section_one_main_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('home_page_section_one_background_image','home_page_section_one_heading','home_page_section_one_spam','home_page_section_one_heading_','home_page_section_one_paragraph','home_page_section_one_button','home_page_section_one_button_link','home_page_section_one_more_details_link','home_page_section_one_main_image','home_page_section_one_card_one_heading','home_page_section_one_card_one_sub_heading','home_page_section_one_card_one_spam','home_page_section_one_card_two_heading','home_page_section_one_card_two_sub_heading','home_page_section_one_card_two_spam','home_page_section_one_card_three_heading','home_page_section_two_heading_one','home_page_section_two_heading_two','home_page_section_three_heading','home_page_section_three_pragraph','home_page_section_four_heading','home_page_section_four_paragraph','home_page_section_one_more_details',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'home_page_section_one_background_image' => $this->input->post('home_page_section_one_background_image',TRUE),
				'home_page_section_one_heading' => $this->input->post('home_page_section_one_heading',TRUE),
				'home_page_section_one_spam' => $this->input->post('home_page_section_one_spam',TRUE),
				'home_page_section_one_heading_' => $this->input->post('home_page_section_one_heading_',TRUE),
				'home_page_section_one_paragraph' => $this->input->post('home_page_section_one_paragraph',TRUE),
				'home_page_section_one_button' => $this->input->post('home_page_section_one_button',TRUE),
				'home_page_section_one_button_link' => $this->input->post('home_page_section_one_button_link',TRUE),
				'home_page_section_one_more_details_link' => $this->input->post('home_page_section_one_more_details_link',TRUE),
				'home_page_section_one_main_image' => $this->input->post('home_page_section_one_main_image',TRUE),
				'home_page_section_one_card_one_heading' => $this->input->post('home_page_section_one_card_one_heading',TRUE),
				'home_page_section_one_card_one_sub_heading' => $this->input->post('home_page_section_one_card_one_sub_heading',TRUE),
				'home_page_section_one_card_one_spam' => $this->input->post('home_page_section_one_card_one_spam',TRUE),
				'home_page_section_one_card_two_heading' => $this->input->post('home_page_section_one_card_two_heading',TRUE),
				'home_page_section_one_card_two_sub_heading' => $this->input->post('home_page_section_one_card_two_sub_heading',TRUE),
				'home_page_section_one_card_two_spam' => $this->input->post('home_page_section_one_card_two_spam',TRUE),
				'home_page_section_one_card_three_heading' => $this->input->post('home_page_section_one_card_three_heading',TRUE),
				'home_page_section_two_heading_one' => $this->input->post('home_page_section_two_heading_one',TRUE),
				'home_page_section_two_heading_two' => $this->input->post('home_page_section_two_heading_two',TRUE),
				'home_page_section_three_heading' => $this->input->post('home_page_section_three_heading',TRUE),
				'home_page_section_three_pragraph' => $this->input->post('home_page_section_three_pragraph',TRUE),
				'home_page_section_four_heading' => $this->input->post('home_page_section_four_heading',TRUE),
				'home_page_section_four_paragraph' => $this->input->post('home_page_section_four_paragraph',TRUE),
				'home_page_section_one_more_details' => $this->input->post('home_page_section_one_more_details',TRUE),
