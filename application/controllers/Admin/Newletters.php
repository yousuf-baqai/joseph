...
class Newletters extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('newletters_pdf',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('newletters_pdf','newletters_heading','newletters_year','newletters_date',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'newletters_pdf' => $this->input->post('newletters_pdf',TRUE),
				'newletters_heading' => $this->input->post('newletters_heading',TRUE),
				'newletters_year' => $this->input->post('newletters_year',TRUE),
				'newletters_date' => $this->input->post('newletters_date',TRUE),
            ...
            $data["output_type"]="row";
            $data['where']=array('newletters_id'=>$id);
