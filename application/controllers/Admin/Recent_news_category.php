...
class Recent_news_category extends Admin_Controller {
    function __construct() {
        parent::__construct();
        $this->image_fields = array('recent_news_category_image',); 
        $this->multi_image_fields = array();; 
        $this->orderable = true;  
        $this->show_fields = array('recent_news_category_name','recent_news_category_slug','recent_news_category_image',);
    }  
    ...
    public function form($form_choice = "",$id="")
    {
        if($_POST){
            $content = array(
				'recent_news_category_name' => $this->input->post('recent_news_category_name',TRUE),
				'recent_news_category_slug' => $this->input->post('recent_news_category_slug',TRUE),
				'recent_news_category_image' => $this->input->post('recent_news_category_image',TRUE),
